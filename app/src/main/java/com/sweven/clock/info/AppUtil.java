...
public class AppUtil {
     ...
     *并将应用软件信息保存到list列表中。
     **/
    public ArrayList<AppMsg> getAllApp(){
        ArrayList<AppMsg> ArrayList = new ArrayList<>();
        AppMsg myAppMsg;
        ...
        for(PackageInfo info:packageInfos){
            ...
            if(filterApp(appInfo) &&
                ...
                myAppMsg.setPackageName(packageName);
                myAppMsg.setAppName(appName);
                myAppMsg.setIcon(icon);

                ArrayList.add(myAppMsg);
            }
